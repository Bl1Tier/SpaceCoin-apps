...
import "../css/home.css";
import { ConfigProvider, Panel, PanelHeader, Avatar, PanelHeaderContent, CardGrid, Card, PullToRefresh, FixedLayout, SimpleCell, Link, Div, Tabs, TabsItem, Footer, Placeholder, Button, Cell, List, Group } from "@vkontakte/vkui";
import bridge from "@vkontakte/vk-bridge";
import { Icon28WheelOutline, Icon28LogoVkColor, Icon28UserCircleOutline, Icon28MenuOutline, Icon28PollSquareOutline, Icon28GameOutline, Icon28LocationOutline, Icon28HeadphonesOutline, Icon28Gift, Icon28DiscussionsCircleFill, Icon28StoryQuestionCircleFillViolet, Icon28AddCircleFillBlue, Icon28GlobeOutline, Icon20StarsFilled, Icon56GestureOutline } from "@vkontakte/icons";
	...
	return (
		<ConfigProvider platform="android">
			<Panel id={props.id}>
				{props.screen === "home" && (
					<Fragment>
						<PanelHeader separator={false} before={<Avatar style={{ borderRadius: "50%" }} size={36} src={props.fetchedUser?.photo_200}/>}><PanelHeaderContent status={props.fetchedUser?.first_name + ' ' + props.fetchedUser?.last_name}>
			<span style={{ color: 'white' }}>Профиль</span>
		  </PanelHeaderContent>
						</PanelHeader>
						{props.loading === 0 && (
							<PullToRefresh onRefresh={props.refreshData} isFetching={props.isLoad}>
								<Fragment>
									<CardGrid
										style={{ padding: 20, paddingTop: 12, paddingBottom: 0 }} size="l">
										<Card className="BalanceImg">
											<div className="balance">
												<div className="coinsTop" style={{ color: "white" }}></div>
												<div className="coins">
													<div className="verticalText" style={{ lineHeight: "30px" }}>{number_format(props.userData.coins)}</div>
													<Icon28WheelOutline width={30} height={30}/>
												</div>
											</div>
										</Card>
				...
				{props.screen === "other" && (
					<Fragment>
						...
						<Div>
							<div onClick={() => bridge.send("VKWebAppAddToCommunity")}><SimpleCell disabled style={{ marginBottom: 10, backgroundColor: "var(--color_background_buttons)", borderRadius: "var(--radius_button)" }} expandable before={<Icon28AddCircleFillBlue fill={"#F39C12"} style={{ paddingRight: 15 }}/>}>Добавить в сообщество</SimpleCell></div>
							<Link hasHover={false} href="https://vk.com/club222370092" target="_blank"><SimpleCell disabled style={{ marginBottom: 10, backgroundColor: "var(--color_background_buttons)", borderRadius: "var(--radius_button)" }} expandable before={<Icon28LogoVkColor fill="#3498DB"style={{ paddingRight: 15 }}/>}>Наша группа</SimpleCell></Link>
							<Link hasHover={false} href="https://vk.me/join/QsggGoNGaqRJJbQw6b4ZCTXapROVybZHVEE=" target="_blank"><SimpleCell disabled style={{ marginBottom: 10, backgroundColor: "var(--color_background_buttons)", borderRadius: "var(--radius_button)" }} expandable before={<Icon28DiscussionsCircleFill fill="#1ABC9C"style={{ paddingRight: 15 }}/>}>Чат игроков</SimpleCell></Link>
							<Link hasHover={false} href="https://vk.me/id701879613" target="_blank"><SimpleCell disabled style={{ marginBottom: 10, backgroundColor: "var(--color_background_buttons)", borderRadius: "var(--radius_button)" }} expandable before={<Icon28HeadphonesOutline fill="#3498DB"style={{ paddingRight: 15 }}/>}>Тех. поддержка</SimpleCell></Link>
								...
								>
									...
									<div
										style={{
											...
											background: "linear-gradient(35deg, #e91e63, #2196f3 100%)",
